        ...
        <section className={styles.section}>
          ...
          <div className={styles.infoGrid}>
            <div className={styles.infoCell}>
              ...
              <p className={styles.note}><strong>NOTE</strong> : un héros verrouillé ne peut plus être utilisé dans le mode constellation.</p>
