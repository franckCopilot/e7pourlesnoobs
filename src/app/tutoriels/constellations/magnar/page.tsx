    ...
    <MainLayout>
      <div className={styles.subContainer}>
        ...
        <section className={styles.section}>
          ...
          {[
            { desc: "Fenne avec beaucoup d'HP, 85% de CC, 350 DCC en destruction et infiltration. Artefact de guilde : drapeau de victoire", img: '/images/tutoriels/chasses/magnar1.png' },
            { desc: "Furious avec un tout petit peu d'HP pour survivre tour 1. Il doit mourir avant son tour 2.", img: '/images/tutoriels/chasses/magnar2.png' },
          ].map((hero, i) => (
