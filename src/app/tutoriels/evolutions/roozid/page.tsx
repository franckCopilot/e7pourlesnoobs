    ...
    <MainLayout>
      <div className={styles.subContainer}>
        ...
        <section className={styles.section}>
          ...
          <p>
            L&apos;évolution de Roozid est peu jouée, il peut remplacer Lilka en PvE
            pour l&apos;expédition glace.
          </p>
        </section>

        <section className={styles.section}>
          <h2 className={styles.sectionTitle}>Comment débloquer Roozid ?</h2>
          <p>Roozid s&apos;obtient en invoquant, principalement avec les Invocation de la prophétie.</p>
          <div className={styles.infoBlock}>
            <img
              ...
              alt="Évolution de Roozid"
              className={styles.infoImage}
            />
            <div className={styles.infoText}>
              <p><strong>Quêtes d&apos;évolution :</strong></p>
              <ul style={{ paddingLeft: '24px', marginBottom: '16px' }}>
                <li>Éliminer 500 Bellmice (UH 11 : 9 elim pour 56 reps ; EP1 4-4 labyrinthe : 29 elim pour 18 reps)</li>
              </ul>
            </div>
          </div>
        </section>
